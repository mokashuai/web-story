...
const blockExportFn = (contentState, block) => {
  ...
  if (block.type === 'block-foo') {
    ...
    return {
      start: `<div class="foo-block-element" data-a="${dataA}">`,
      end: '</div>'
    }
  ...
  if (block.type === 'block-bar') {
    ...
    return {
      start: `<div class="bar-block-component" data-b="${dataB}"><button className="button-remove"><i className="bfi-bin"></i>`,
      end: '</button></div>'
    }
  }
...
const editorState = BraftEditor.createEditorState(initialContent, { blockImportFn, blockExportFn })
...
export default class BasicDemo extends React.Component {
  ...
  render () {
    ...
    return (<>
      ...
      <div className="output-content bf-container" dangerouslySetInnerHTML={{__html: outputHTML}}/>
    </>)
  }
